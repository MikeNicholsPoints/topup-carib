...
var postOrderBalance = 0;

var eventMethod = window.addEventListener ? "addEventListener" : "attachEvent";
var eventer = window[eventMethod];
var messageEvent = eventMethod == "attachEvent" ? "onmessage" : "message";

//listening for the storefront to let the top up pop up know the new balance after an order is complete 
...
eventer(messageEvent,function(e) {
    ...
    if(data.method == "updateBalance"){
        postOrderBalance = data.balance;
        console.log("got new balance from storefront " + postOrderBalance + " " + data.balance);
    }
},false);

//update the parameter in the js function passed to successURL to contain balance, for amadeus 
function addBalanceToURL(url){
    var newParameters = '(' + postOrderBalance + ')';
    url = url.replace('()',newParameters);
    return url;
}
...
(function (n, D) {
  (function () {
      ...
      switch (p) {
        ...
        case "[object RegExp]":
          return (
            a.source == g.source &&
            a.global == g.global &&
            a.multiline == g.multiline &&
            a.ignoreCase == g.ignoreCase
          );
      }
      if ("object" != typeof a || "object" != typeof g) return !1;
      for (var b = q.length; b--; ) if (q[b] == a) return !0;
      q.push(a);
      var b = 0,
        d = !0;
      if ("[object Array]" == p) {
        ...
        if (
          "constructor" in a != "constructor" in g ||
          a.constructor != g.constructor
        )
          return !1;
        for (var e in a)
          if (c.has(a, e) && (b++, !(d = c.has(g, e) && f(a[e], g[e], q))))
            break;
        if (d) {
          for (e in g) if (c.has(g, e) && !b--) break;
          d = !b;
        }
      }
      q.pop();
    ...
    "undefined" !== typeof exports
      ...
      : (e._ = c);
    c.VERSION = "1.3.1";
    var w = (c.each = c.forEach = function (a, g, q) {
      if (null != a)
        if (t && a.forEach === t) a.forEach(g, q);
        else if (a.length === +a.length)
          for (
            var p = 0, b = a.length;
            p < b && !(p in a && g.call(q, a[p], p, a) === l);
            p++
          );
        else for (p in a) if (c.has(a, p) && g.call(q, a[p], p, a) === l) break;
    });
    ...
    c.reduce = c.foldl = c.inject = function (a, g, q, p) {
      ...
      null == a && (a = []);
      if (v && a.reduce === v)
        return p && (g = c.bind(g, p)), b ? a.reduce(g, q) : a.reduce(g);
      w(a, function (a, c, d) {
    ...
    c.reduceRight = c.foldr = function (a, g, q, p) {
      var b = 2 < arguments.length;
      null == a && (a = []);
      if (x && a.reduceRight === x)
        return (
          p && (g = c.bind(g, p)), b ? a.reduceRight(g, q) : a.reduceRight(g)
        );
    ...
    c.last = function (a, c, d) {
      return null != c && !d
        ? b.call(a, Math.max(a.length - c, 0))
        : a[a.length - 1];
    };
    ...
    c.uniq = c.unique = function (a, g, b) {
      ...
      c.reduce(
        b,
        function (b, q, e) {
          if (0 == e || (!0 === g ? c.last(b) != q : !c.include(b, q)))
            (b[b.length] = q), (d[d.length] = a[e]);
          return b;
        },
        []
      );
    ...
    c.indexOf = function (a, g, b) {
      if (null == a) return -1;
      var d;
      if (b) return (b = c.sortedIndex(a, g)), a[b] === g ? b : -1;
      if (z && a.indexOf === z) return a.indexOf(g);
      b = 0;
      for (d = a.length; b < d; b++) if (b in a && a[b] === g) return b;
      return -1;
    };
    c.lastIndexOf = function (a, c) {
      if (null == a) return -1;
      if (u && a.lastIndexOf === u) return a.lastIndexOf(c);
      for (var b = a.length; b--; ) if (b in a && a[b] === c) return b;
      return -1;
    };
    c.range = function (a, c, b) {
      ...
      b = arguments[2] || 1;
      for (
        var d = Math.max(Math.ceil((c - a) / b), 0), e = 0, f = Array(d);
        e < d;
    ...
    c.bind = function (a, g) {
      var d, e;
      if (a.bind === G && G) return G.apply(a, b.call(arguments, 1));
      if (!c.isFunction(a)) throw new TypeError();
      e = b.call(arguments, 2);
      return (d = function () {
        if (!(this instanceof d))
          return a.apply(g, e.concat(b.call(arguments)));
    ...
    c.clone = function (a) {
      return !c.isObject(a) ? a : c.isArray(a) ? a.slice() : c.extend({}, a);
    };
    c.tap = function (a, c) {
      c(a);
      return a;
    ...
    c.isEmpty = function (a) {
      ...
      for (var b in a) if (c.has(a, b)) return !1;
      return !0;
    };
      ...
      var d = c.templateSettings,
        d =
          ...
          a
            .replace(/\\/g, "\\\\")
            .replace(/'/g, "\\'")
            .replace(d.escape || H, function (a, c) {
              return "',_.escape(" + I(c) + "),'";
            })
            .replace(d.interpolate || H, function (a, c) {
              return "'," + I(c) + ",'";
            })
            .replace(d.evaluate || H, function (a, c) {
              return "');" + I(c).replace(/[\r\n\t]/g, " ") + ";__p.push('";
            })
            .replace(/\r/g, "\\r")
            .replace(/\n/g, "\\n")
  ...
  TINY.box = (function () {
    ...
    return {
      show: function (b) {
        ...
        k
          ? ((f.style.display = "none"),
            clearTimeout(k.ah),
            l.v && (k.removeChild(l), (l.v = 0)))
          : ((f = document.createElement("div")),
            (f.className = "tbox"),
            (k = document.createElement("div")),
            (k.className = "tinner"),
            (h = document.createElement("div")),
            (h.className = "tcontent"),
            ...
            f.appendChild(k),
            k.appendChild(h),
            (e.onclick = l.onclick = TINY.box.hide),
            (n.onresize = TINY.box.resize));
        k.id = d.boxid;
        e.id = d.maskid;
        ...
        d.html && !d.animate
          ...
          : ((h.style.display = "none"),
            !d.animate && d.width && d.height
              ? ((k.style.width = d.width + "px"),
                (k.style.height = d.height + "px"))
              : (k.style.width = k.style.height = "100px"));
        d.mask
          ? (this.mask(), this.alpha(e, 1, d.opacity))
          : this.alpha(f, 1, 100);
        d.autohide
          ? (k.ah = setTimeout(TINY.box.hide, 1e3 * d.autohide))
          ...
          if (d.image) {
            ...
            x.onreadystatechange = function () {
              4 == x.readyState &&
                ...
                TINY.box.psh(x.responseText, h, t, l));
            };
            f
              ? (x.open("POST", b, !0),
                x.setRequestHeader(
      ...
      psh: function (b, d, e, f) {
        ...
        b = k.style.width;
        var t = k.style.height;
        if (!e || !f)
          (k.style.width = e ? e + "px" : ""),
            (k.style.height = f ? f + "px" : ""),
            (h.style.display = ""),
            f || (f = parseInt(h.offsetHeight)),
            e || (e = parseInt(h.offsetWidth)),
            (h.style.display = "none");
        k.style.width = b;
        k.style.height = t;
        this.size(e, f, d);
      ...
      mask: function () {
        ...
        e.style.width = this.total(0) + "px";
      },
      pos: function () {
        var b;
        "undefined" != typeof d.top
          ? (b = d.top)
          : ((b = this.height() / d.topsplit - f.offsetHeight / 2),
            (b = 20 > b ? 20 : b));
        !d.fixed && !d.top && (b += this.top());
        f.style.top = b + "px";
        f.style.left =
          "undefined" != typeof d.left
            ? d.left + "px"
            : this.width() / 2 - f.offsetWidth / 2 + "px";
      },
          ...
          ? (clearInterval(b.ai),
            -1 == r
              ? ((b.style.display = "none"),
                b == f
                  ? TINY.box.alpha(e, -1, 0, 2)
                  : (h.innerHTML = k.style.backgroundImage = ""))
              : b == e
              ? this.alpha(f, 1, 100)
              : ((f.style.filter = ""),
                TINY.box.fill(
                  d.html || d.url,
                  d.url || d.iframe || d.image,
                  d.post,
                  d.animate,
                  d.width,
                  d.height
                )))
          : ((l -= Math.floor(0.5 * Math.abs(l - n)) * r),
            (b.style.opacity = l / 100),
            (b.style.filter = "alpha(opacity=" + l + ")"));
      },
      size: function (b, e, f) {
        if (f) {
          clearInterval(k.si);
      ...
      ts: function (b, e, f, n) {
        ...
        t == b && A == f
          ...
          : (t != b &&
              (k.style.width =
                b - Math.floor(0.6 * Math.abs(b - t)) * e + "px"),
            A != f &&
              (k.style.height =
                f - Math.floor(0.6 * Math.abs(f - A)) * n + "px"),
            this.pos());
      },
      top: function () {
      ...
      total: function (b) {
        ...
        return b
          ? Math.max(
              Math.max(d.scrollHeight, e.scrollHeight),
              Math.max(d.clientHeight, e.clientHeight)
            )
          : Math.max(
              Math.max(d.scrollWidth, e.scrollWidth),
              Math.max(d.clientWidth, e.clientWidth)
            );
      }
    };
  })();
  (function () {
    function f(e, h, l) {
      var d = /\[\]$/;
      if (_.isArray(h))
        _.each(h, function (b, h) {
          d.test(e)
            ? l(e, h)
            : f(
                e +
                  "[" +
                  ("object" === typeof h || _.isArray(h) ? b : "") +
                  "]",
                h,
                l
              );
      ...
      param: function (e) {
        var h = [],
          l = function (d, b) {
            ...
            if (b !== undefined)
              h[h.length] = encodeURIComponent(d) + "=" + encodeURIComponent(b);
          };
        if (_.isArray(e))
          _.each(e, function () {
            l(this.name, this.value);
          });
        else for (var d in e) f(d, e[d], l);
  ...
  PTS.namespace = function (f) {
    ...
    for (var h = 0; h < f.length; h++)
      "undefined" === typeof e[f[h]] && (e[f[h]] = {}), (e = e[f[h]]);
    return e;
  };
  PTS.JsonpFetcher = (function (f, e, h) {
    ...
    h.get = function (d, e, h, v) {
      ...
      for (b in e)
        e.hasOwnProperty(b) &&
          (k += encodeURIComponent(b) + "=" + encodeURIComponent(e[b]) + "&");
      r = "pts_json" + ++l;
      f[r] = function (b) {
        h(b);
        try {
  ...
  PTS.logging.Logger.prototype.log = function (f, e) {
    ...
    n.console &&
      (console.log(h),
      PTS.debugMode && !_.isUndefined(f) && console.log(f.stack));
  };
  ...
  PTS.errors.ErrorHandler = (function () {
    ...
    f.prototype = {
      ...
      handleError: function (e, f) {
        e instanceof PTS.errors.ValidationError &&
          (_.isFunction(f)
            ? f(e)
            : e.visible &&
              alert(
  ...
  PTS.errors.ValidationError.prototype = Error();
  (function (f, e, h) {
    function l(b) {
      b = b || e;
    ...
    function k(b) {
      ...
      k === B &&
        (b.target === f && !b.shiftKey
          ? (b.preventDefault(), d(h))
          : b.target === h && b.shiftKey && (b.preventDefault(), d(f)));
    }

    function b(d) {
      return d === e
        ? !0
        : !d.hidden && "none" !== d.style.display && b(d.parentNode);
    }
  ...
  PTS.isEligibleForOffer = function (config) {
    ...
    if (cabin === "Economy" && uaeAirports.indexOf(origin) > -1) {
      threshold = 0.5;
    }

    var percentNeededToRedeem =
      (config.redemptionQuantity - config.transactionQuantity) /
      config.redemptionQuantity;
  ...
  PTS.performOptionalOfferCallback = function (f) {
    if (_.isFunction(f.offerCallback)) {
      ...
      if (!_.isString(f.mvDelegate) || !PTS.isEligibleForOffer(f))
        setTimeout(function () {
          f.offerCallback(e);
        });
      else {
        ...
        return PTS.JsonpFetcher.get(
          ...
          function (h) {
            ...
            if (_.get(h, "increments.length")) {
              var d = _.max(
                _.map(h.increments, function (d) {
                  return d.bonus
                    ? d.basePoints + d.bonus.calculatedAmount
                    : d.basePoints;
                })
              );
              f.transactionQuantity > d
                ? f.offerCallback(e)
                : f.offerCallback({
                    offer: h
                  });
  ...
  PTS.inlineBuy = (function () {
    var f = n.document,
      ...
      A = new PTS.logging.RemoteLogger(
      ...
      x = function (u) {
        var m = {};
        _.extend(m, h, u);
        m.partnerTransactionId =
          m.partnerTransactionId ||
          [m.partnerName, +new Date(), _.randomInt(1e4, 1e5)].join("");
        if (m.memberData && aesjs) {
          ...
          var aesCbc = new aesjs.ModeOfOperation.ecb(
            aesjs.utils.hex.toBytes(myPassword)
          );
          var decryptedMemberData = aesjs.utils.utf8
            .fromBytes(
              aesjs.padding.pkcs7.strip(aesCbc.decrypt(encryptedBytes))
            )
            .split("|");
        ...
        m.mvDelegate
          ...
          : ((u =
              m.ssoGatewayUrl ||
              _.compiled(
                "https://obuat.ssogateway.points.com/SSOGateway/gateway.do"
              )),
            (u += -1 === u.indexOf("?") ? "?" : "&"),
            (u += _.param({
        ...
        TINY.box.hide = function (b) {
          if (F(b))
            if (_.isFunction(m.closeDialogCallback))
              ...
              var c = "",
                d = function () {
                  "COMPLETED" === c &&
                    ("" !== m.successUrl
                      ? (n.location.href = addBalanceToURL(m.successUrl))
                      : n.location.reload());
                  e();
                };
              PTS.JsonpFetcher.get(
                _.compiled(
                  "https://storefront-staging.lxc.points.com/order-status"
                ),
                {
                ...
                function (b) {
                  ...
                  if ("COMPLETED" === b || ("NOT_COMPLETED" === b && "" === c))
                    //var preOrderBalance = document.getElementById('pts-iframe').contentWindow.storefront.data('receipt').user.balance; //get pre order balance from iframe
                    //console.log("storefront data balance " +preOrderBalance);
                    c = b;
              ...
              confirm(m.closeConfirm) &&
                ("" !== c
                  ? d()
                  : ((b = _.getChildByClassName(DIALOGID, "tclose")),
                    (b.className += " pts-close-waiting"),
                    n.setTimeout(function () {
                      "" !== c
                        ? d()
                        : (v("transaction status jsonp call never returned"),
                          e());
                    }, 2e3)));
            }
        };
        TINY.box.show({
          ...
          boxid: DIALOGID,
          maskid: "pts-mask",
          width: m.boxWidth || 750,
          height: Math.max(
            Math.floor(_.getViewportHeight()) - (m.boxVerticalMargin || 80),
            400
          ),
          fixed: !1,
          maskopacity: 40,
          openjs: function () {
            ...
            d.setAttribute(
              "style",
              "display:none;min-width:100%;min-height:100%;"
            );
            d.innerText =
            ...
            b.appendChild(c);
            b.appendChild(d);
            if ((b = _.getChildByClassName(DIALOGID, "tclose")))
              (b.innerHTML =
      ...
      D = function (b, d) {
        ...
        _.each(d, function (c) {
          ...
          (_.isUndefined(d) ||
            _.isNull(d) ||
            (_.isString(d) && 0 === d.length)) &&
            e.push(c + " is required");
        });
        return e;
      },
      F = function (b) {
    ...
    if (_.isUndefined(n.pointsAsyncInit)) {
      ...
      try {
        _.extend(h, n.pointsAsyncInit() || {}),
          (d || !PTS.debugMode) && _.nullify(h, l),
          ...
          y.appendChild(
            f.createTextNode(
              ".tbox{position:absolute;display:none;padding:14px 17px;z-index:900}#" +
                DIALOGID +
                "{padding:0;-moz-border-radius:5px;border-radius:5px;background:#fff url(https://staging.static.points.com/buy/default/buy/images/preload.gif) no-repeat 50% 50%;border-right:1px solid #333;border-bottom:1px solid #333}#pts-mask{position:absolute;display:none;top:0;left:0;height:100%;width:100%;background:#000;z-index:800}#" +
                DIALOGID +
                " .pts-close-x{position:relative;top:2px;}#" +
                DIALOGID +
                " .tclose{position:absolute;top:10px !important;right:10px !important;width:80px;height:30px;cursor:pointer;font-family:helvetica,sans-serif;font-size:20px}#" +
                DIALOGID +
                " .pts-close-waiting{background:url(https://staging.static.points.com/buy/default/buy/images/closespinner.gif) no-repeat 100% 0; text-indent:-5000px; top:15px !important; right: 19px !important;}#" +
                DIALOGID +
                " .pts-close-text{font-size:12px;}"
            )
          ),
          f.getElementsByTagName("head")[0].appendChild(y),
          PTS.performOptionalOfferCallback(h);
      } catch (z) {
        z.message =
          "Error when executing window.pointsAsyncInit(): " + z.message;
        B.handleError(z);
        v(z);
        return;
      }
